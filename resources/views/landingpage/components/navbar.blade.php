...
<nav id="navbar" class="w-full bg-white text-black shadow-md fixed top-0 left-0 right-0 z-10">
	<div class="max-w-screen-lg mx-auto px-2 sm:px-4 py-0">
		<div class="flex justify-start md:justify-between gap-2 items-center">
			...
			<a href="/" class="p-2">
				<img src="/dist/img/main-logo-horizontal-black.png" alt="Logo SanguKu" width="120" class="">
			</a>

			<div id="navbarMenu" class="hidden md:block absolute md:relative top-full left-0 right-0 z-20">
				<ul class="flex m-0 flex-col md:flex-row w-full bg-white justify-center items-center" data-sticky-background>
